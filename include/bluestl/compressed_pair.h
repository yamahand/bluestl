...
namespace bluestl
{
    ...
    public:
        ...
        // アクセサ
        first_type &first() { return static_cast<T1 &>(*this); }
        const first_type &first() const { return static_cast<const T1 &>(*this); }
        second_type &second() { return static_cast<T2 &>(*this); }
        const second_type &second() const { return static_cast<const T2 &>(*this); }
    };
    ...
    public:
        ...
        // アクセサ
        first_type &first() { return base_type::first(); }
        const first_type &first() const { return base_type::first(); }
        second_type &second() { return base_type::second(); }
        const second_type &second() const { return base_type::second(); }
    };
}