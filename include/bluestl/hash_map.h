...
public:
    ...
    public:
        ...
        // Constructor
        hash_iterator(const hash_map* container, size_type index) noexcept
            : container_(container), index_(index) {
            advance_to_valid();
        }
        
        // Copy constructor
        hash_iterator(const hash_iterator& other) noexcept
        ...
        reference operator*() const noexcept {
            BLUESTL_ASSERT(container_ && index_ < container_->capacity_ && 
                   container_->buckets_[index_].used && 
